...
(async function(){
    try {
        ...
        const respuesta = await fetch(`https://achicopalados.mainfleeteye.club/datos_usuario/${localStorage.getItem("token") || "singup"}`, {
...
function iniciarApp(){
    ...
    async function enviaPeticion(datos){
        try{
            const resultado = await fetch("https://achicopalados.mainfleeteye.club/crearReserva", {
                method: "POST",
                headers: {
